...
export const TRANSLATIONS = {
  ZH: {
    ...
    monthLabel: '第{n}月',
    // Affordability
    affordabilityTitle: "购房预算与购买力分析",
    downPaymentCapacity: "首付能力",
    maxAffordableMonthlyPayment: "最大承受月供",
    maxAffordablePrice: "最大购买力",
    dtiRatio: "DTI 负债收入比",
    paymentVsIncome: "月供 vs 收入对比",
    incomeStressTest: "收入压力测试",
    stressTestIncomeDown20: "收入下降20%",
    stressTestRateUp1: "利率上涨1%",
    stressTestCombined: "组合场景",
    stressTestSafe: "安全",
    stressTestWarning: "警告",
    stressTestDanger: "危险",
    stressTestNewIncome: "新收入",
    stressTestNewDTI: "新DTI",
    stressTestShortfall: "缺口",
    stressTestNewRate: "新利率",
    stressTestNewPayment: "新月供",
    stressTestExtraCost: "额外成本",
    dtiSafe: "安全 (<30%)",
    dtiWarning: "警告 (30-50%)",
    dtiDanger: "危险 (>50%)",
    affordabilityDesc: "基于您的收入和储蓄情况，评估您的购房能力和财务风险。",
