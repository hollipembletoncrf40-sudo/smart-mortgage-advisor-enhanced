...
export const TRANSLATIONS = {
  ZH: {
    ...
    rentVsBuyAnalysis: '租房 vs 买房',
    buyScenario: '买房自住',
    rentScenario: '租房理财',
    buyNetWorth: '买房净资产',
    rentNetWorth: '租房净资产',
    breakevenPoint: '盈亏平衡点',
    breakevenDesc: '在第 {year} 年，买房的总资产开始超过租房。',
    neverBreakeven: '在持有期内，租房理财更划算。',
    monthlyCostDiff: '月度支出差异',
    buyCost: '买房支出',
    rentCost: '租房支出',
    investDiff: '差额投资',
    diffAnalysis: '第 {year} 年，{winner} 方案更优，净资产多 {diff} {unit}。',
  },
  EN: {
