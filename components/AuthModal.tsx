      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 max-w-md w-full mx-4 animate-fade-in">
        ...
        <div className="space-y-3 mb-6">
          ...
          >
            ...
            <span className="font-medium text-slate-700 dark:text-white">使用 Google 登录</span>
          </button>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white dark:bg-slate-800 text-slate-500 dark:text-slate-400">或使用邮箱</span>
          </div>
        </div>
