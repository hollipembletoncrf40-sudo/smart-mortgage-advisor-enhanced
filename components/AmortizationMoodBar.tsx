...
const AmortizationMoodBar: React.FC<AmortizationMoodBarProps> = ({ result, params, t }) => {
  ...
  return (
    <div className="bg-white dark:bg-black rounded-3xl p-6 shadow-xl border border-slate-200 dark:border-slate-800">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full h-2 bg-slate-200 dark:bg-slate-900 rounded-lg appearance-none cursor-pointer accent-indigo-500"
        />
      ...
      {/* Mood Bar */}
      <div className="mb-4">
        <div className="h-16 w-full rounded-2xl overflow-hidden shadow-inner bg-slate-200 dark:bg-slate-900 flex">
          {/* Principal (Green) */}
          <div 
        ...
        <div className="flex justify-between mt-2 text-xs">
          <div className="flex items-center gap-1">
            ...
            <span className="text-slate-700 dark:text-slate-300">{t.principal || '本金'}</span>
          </div>
          <div className="flex items-center gap-1">
            <div className="w-3 h-3 rounded-full bg-red-500"></div>
            <span className="text-slate-700 dark:text-slate-300">{t.interest || '利息'}</span>
          </div>
        </div>
      </div>
